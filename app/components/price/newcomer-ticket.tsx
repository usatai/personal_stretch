  ...
  return (
    <div>
      ...
      <div className="rounded-2xl overflow-hidden shadow-[0_4px_24px_rgba(249,115,22,0.18)] mb-6">
        <div className="bg-linear-to-r from-orange-500 to-orange-600 px-6 py-4 flex flex-col sm:flex-row items-center justify-center gap-2 text-center">
          ...
          <span className="bg-white text-orange-600 font-black text-lg md:text-xl px-4 py-0.5 rounded-full">
            {discountLabel(plan.discountRate)}
          </span>
          <span className="text-orange-100 text-sm">— {plan.note}</span>
        </div>
      </div>
          ...
          return (
            ...
            >
              <div className="flex items-center justify-between mb-1">
                ...
                <span className="text-[10px] font-bold text-orange-600 bg-orange-50 border border-orange-200 px-2 py-0.5 rounded-full whitespace-nowrap">
                  全{plan.sessions}回
                </span>
              </div>
              ...
              <dl className="mt-4 space-y-1.5 text-sm">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <dd className="font-bold text-orange-600">−¥{formatYen(tier.saved)}</dd>
                </div>
              </dl>
            </article>
          );
